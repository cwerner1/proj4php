...
class ProjFourphp_ProjMoll
{
    ...
    public function forward($p)
    {
        ...
        for ($i = 0; true; ++$i) {
            ...
            $theta += $deltaTheta;
            if (abs($deltaTheta) < ProjFourphp_Common::$epsln) break;
            if ($i >= 50) {
        ...
        /* If the latitude is 90 deg, force the x coordinate to be "0 .
         *  false easting"
    ...
    public function inverse($p)
    {
        ...
        /* Because of division by zero problems, 'arg' can not be 1.0.
         *   Therefore
